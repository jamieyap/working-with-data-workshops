...
```{r, echo = FALSE, fig.align = 'center', out.height = '40%', out.width = '40%', fig.cap = 'Timeline'}
...
A similar logic to Steps 3 and 4 above may be used to estimate the model for Scientific Question 2. 
